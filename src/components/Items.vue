<template>
  <div id="items" class="h-24 min-h-screen bg-gray-300">
        <div class="bg-gray-100">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              class="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none"
            >
              <h2 class="text-2xl font-extrabold text-gray-900">Shops</h2>
              ...
              <div
                ...
                "
              >
                <div class="group relative" v-for="item in items" :key="item.id">
                  <div
                    class="
                      relative
                      w-full
...
export default {
  ...
  async created() {
    ...
    //Wait until api call has loaded
  },
  methods: {
    async loadItems() {
      this.items = [];
